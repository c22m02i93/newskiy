...
if (!function_exists('bs_woocommerce_breadcrumbs')) :
  ...
  function bs_woocommerce_breadcrumbs() {
    return array(
      'delimiter'   => '',
      'wrap_before' => "<nav aria-label='breadcrumb' class='wc-breadcrumb " . apply_filters('bootscore/class/breadcrumb/nav', 'hram-breadcrumb overflow-x-auto text-nowrap mb-4 mt-2') . "'>
      <ol class='breadcrumb hram-breadcrumb__list " . apply_filters('bootscore/class/breadcrumb/ol', 'flex-nowrap mb-0') . "'>
