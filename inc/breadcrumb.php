...
if (!function_exists('the_breadcrumb')) :
  function the_breadcrumb() {
    ...
    if (!is_home()) {
      echo '<nav aria-label="breadcrumb" class="' . apply_filters('bootscore/class/breadcrumb/nav', 'hram-breadcrumb overflow-x-auto text-nowrap mb-4 mt-2') . '">';
      echo '<ol class="breadcrumb hram-breadcrumb__list ' . apply_filters('bootscore/class/breadcrumb/ol', 'flex-nowrap mb-0') . '">';
